...
ndiff_test(test-ptc-track-4 1)
ndiff_test(test-ptc-track-5 1)
ndiff_test(test-ptc-track-acd 0)
ndiff_test(test-ptc-track-acd-2 0)
ndiff_test(test-ptc-track-6Dtl-acd 0)
ndiff_test(test-ptc-align 0)
ndiff_test(test-ptc-align-2 0)
...
ndiff_test(test-rfmultipole-7 0)
...
ndiff_test(test-track-acd 0)
ndiff_test(test-track-rotations 0)
...
ndiff_test(test-thick-rbend 0)

ndiff_test(test-thick-solenoid 0)
...
ndiff_test(test-ptc-twiss-56Dt-ini_mtx_man 1)
ndiff_test(test-ptc-twiss-56Dt-ini_mtx_tbl 1)
ndiff_test(test-ptc-twiss-normal-genfu 1)
...
ndiff_test(test-sequence-7 0)
ndiff_test(test-sequence-8 0)
ndiff_test(test-sequence-9 0)
...
ndiff_test(test-elseparator 0)
ndiff_test(test-translation 0)
ndiff_test(test-xrotation 0)
ndiff_test(test-yrotation 0)
